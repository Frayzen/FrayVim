    ...
    __conda_setup="$('/home/phoenix/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
    if [ $? -eq 0 ]; then
        eval "$__conda_setup"
    else
    ...
    # export PYTHONPATH="$PYTHONPATH:/home/phoenix/miniconda3/pkgs/muscat-core-2.2.2-py312haff4bf5_0/lib/python3.12/site-packages/"
    unset __conda_setup
    # <<< conda initialize <<<
